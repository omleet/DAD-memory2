...
const confirmPassword = ref(''); // Novo campo para confirmar a senha
    ...
    <div class="max-w-2xl mx-auto py-8">
      ...
      <div class="bg-white p-6 rounded-lg shadow-lg">
        ...
        <div class="space-y-4">
          ...
          <div class="flex flex-col space-y-1.5">
            <label class="font-bold text-gray-900">Update Password</label>
            <input type="password" placeholder="New Password" v-model="credentials.password"
              class="border border-gray-300 p-2 rounded" />
          </div>
          <div class="flex flex-col space-y-1.5">
            <label class="font-bold text-gray-900">Confirm Password</label>
