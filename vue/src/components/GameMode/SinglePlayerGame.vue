<template>
  <div class="bg-gray-100 p-6 rounded-lg shadow-lg relative">
    <!-- Back button -->
    <button @click="router.push('/')" class="absolute top-4 left-4 bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-2 px-4 rounded-full flex items-center justify-center">
...
>>>>>>> f19336e4432b9b8f1e3d04e56e8c9740cca7f16b
            ...
            <button @click="handleGameModeClick('/cardgame6x6')" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded inline-block">
              Game 6x6
            </button>
          </div>
        </div>
    ...
    <div v-if="spGameStore.showModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div class="bg-white p-6 rounded-lg shadow-lg max-w-sm w-full text-center">
        ...
        <div class="flex justify-between">
          ...
          <button @click="confirmUseBrainCoin" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
            Use 1 BrainCoin
          </button>
        </div>
      </div>
    ...
    <div v-if="spGameStore.showNotEnoughCoinsModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div class="bg-white p-6 rounded-lg shadow-lg max-w-sm w-full text-center">
        ...
        <div class="flex justify-between">
          ...
          <button @click="router.push('/purchasebraincoins')" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
            Buy BrainCoins
          </button>
        </div>
      </div>
